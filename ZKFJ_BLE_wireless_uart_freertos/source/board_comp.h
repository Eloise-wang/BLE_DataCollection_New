...
#else
#define BOARD_BUTTON0_GPIO_PORT_INSTANCE     PORT_ADDR2IDX(BOARD_INITPINBUTTON1_SW3_PORT)
#define BOARD_BUTTON0_GPIO_PIN               BOARD_INITPINBUTTON1_SW3_PIN
#define BOARD_BUTTON0_GPIO_PIN_DEFAULT_STATE 1U

#define BOARD_BUTTON1_GPIO_PORT_INSTANCE     PORT_ADDR2IDX(BOARD_INITPINBUTTON1_SW3_PORT)
#define BOARD_BUTTON1_GPIO_PIN               BOARD_INITPINBUTTON1_SW3_PIN
#define BOARD_BUTTON1_GPIO_PIN_DEFAULT_STATE 1U
#endif
